...
function HallucinationSlide({ slideNum }) {
  return (
    <div className="slide fade-up">
      ...
      <h2>למה הזיות הן <em>בלתי נמנעות</em> מבניית.</h2>
      <p className="slide-sub">תופעת ההזיה אינה באג. היא תוצאה ישירה של מערכת יוצרת (Generative System).</p>
      <div className="venn-wrap">
        <div className="venn-circle venn-left">יצירתיות</div>
        <div className="venn-circle venn-right">הזיה</div>
        <div className="venn-overlap">חפיפה מובנית</div>
        <div className="venn-outer"><span className="venn-outer-label">Guardrails ארגוניים</span></div>
      </div>
      <div className="biz-equation">
        <span className="eq-strike">Enterprise AI = Model</span><br />
        Enterprise AI <span className="eq-op">=</span> Model <span className="eq-op">+</span> Guardrails
      </div>
      <Highlight><em>Creativity and hallucination are neighboring phenomena.</em> אי אפשר לבנות מערכת יצירתית ללא פוטנציאל מובנה להזיה.</Highlight>
    </div>
  );
}
